...
export default function FuncScreen({ user, onLogout }) {
  ...
  const toastConfig = {
    success: (props) => (
      <BaseToast
        {...props}
        style={{ borderLeftColor: "#2ECC71", backgroundColor: "#1E1E1E" }}
    ...
    error: (props) => (
      <ErrorToast
        {...props}
        style={{ borderLeftColor: "#E74C3C", backgroundColor: "#1E1E1E" }}
        contentContainerStyle={{ paddingHorizontal: 15 }}
        text1Style={{
          fontSize: 16,
          fontWeight: "bold",
  ...
  async function confirmarReceita() {
    ...
    Toast.show({
      ...
      text2: "Tudo atualizado no estoque.",
      position: "bottom",
    });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <TouchableOpacity
          style={[styles.button, telaAtual === "estoque" && { backgroundColor: "#2E8B57" }]}
        ...
        <TouchableOpacity
          style={[styles.button, telaAtual === "receitas" && { backgroundColor: "#4682B4" }]}
      ...
      <View style={styles.logoutContainer}>
        <TouchableOpacity
          style={[styles.button, { backgroundColor: "#C0392B", width: 120 }]}
          onPress={onLogout}
        >
